    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_status', models.CharField(choices=[('created', 'Created'), ('paid', 'Paid'), ('shipped', 'Shipped'), ('delivered', 'Delivered'), ('canceled', 'Canceled')], default='created', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('payment_method', models.CharField(choices=[('credit_card', 'Credit card'), ('debit_card', 'Debit card'), ('digital_wallet', 'Digital Wallet'), ('bank', 'Bank')], max_length=50)),
